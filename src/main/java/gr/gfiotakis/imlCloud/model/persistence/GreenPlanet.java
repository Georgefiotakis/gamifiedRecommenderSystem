...
@Entity
@Table(name = "green_planet")
public class GreenPlanet {

    Integer greenPlanetId;
    String questionOne;
    String questionTwo;
    ...
    @Column(name = "green_planet_id", nullable = false)
    public Integer getGreenPlanetId() {
        return greenPlanetId;
    }

    public void setGreenPlanetId(Integer greenPlanetId) {
        this.greenPlanetId = greenPlanetId;
    }
