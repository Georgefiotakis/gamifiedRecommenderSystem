...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<script src="${pageContext.request.contextPath}/resources/js/purplePlanet.js"></script>
<style>
    ...
    .pcoded-main-container {
        background: url(./resources/img/planet-cartoon-purple.jpg) no-repeat center center fixed;
...
<%--                                               onclick="backToDashboard()">--%>
                                    ...
                                    <div class="col-lg-3 nextButtonDiv">
                                        <canvas></canvas>
                                        <button id="purpleNextButton" type="button" onclick="nextToOrangePlanet()">
                                            <span>Proceed...</span>
                                        </button>
                                    </div>
                                </div>
