...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<script src="${pageContext.request.contextPath}/resources/js/greenPlanet.js"></script>
<style>
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-3 backButtonDiv">
                                        <button class="button2" type="button" onclick="backToDashboard()">
                                            <span>Back...</span>
                                        </button>
                                    </div>
                                    <div class="currentUserId" id="currentUserId"style="display: none"><c:out value="${currentUserId}"/>
<%--                                        <h4 class="latitudeCountry" value="<c:out value="${currentUserId}"/>"><c:out value="${currentUserId}"/></h4>--%>
                                    </div>
                                    <div class="currentSurveyId" id="currentSurveyId" style="display: none"><c:out value="${currentSurveyId}"/>
<%--                                        <h4 class="latitudeCountry" value="<c:out value="${currentSurveyId}"/>"><c:out value="${currentSurveyId}"/></h4>--%>
                                    ...
                                    <div class="col-lg-3 nextButtonDiv">
                                        <canvas></canvas>
                                        <button id="greenNextButton" type="button" onclick="nextToPurplePlanet()">
                                            <span>Proceed...</span>
                                        </button>
                                    </div>
                                </div>
