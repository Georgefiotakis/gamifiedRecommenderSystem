...
$(document).ready(function () {
    ...
    // var currentUserId;
    // var currentSurveyId;
    document.getElementById("orangeNextButton").disabled = true;
    document.getElementById("orangeNextButton").style.opacity = 0.1;
...
function takeInstantiateAnswers() {
    ...
    $('.questionOne label').click(function () {
        ...
        var x = document.getElementById("questionOne").getElementsByClassName("checked");
    ...
    $('.questionTwo label').click(function () {
        $(this).addClass("checked").siblings().removeClass("checked");
        var x = document.getElementById("questionTwo").getElementsByClassName("checked");
    ...
    $('.questionThree label').click(function () {
        $(this).addClass("checked").siblings().removeClass("checked");
        var x = document.getElementById("questionThree").getElementsByClassName("checked");
    ...
    $('.questionFour label').click(function () {
        $(this).addClass("checked").siblings().removeClass("checked");
        var x = document.getElementById("questionFour").getElementsByClassName("checked");
    ...
    $('.questionFive label').click(function () {
        $(this).addClass("checked").siblings().removeClass("checked");
        var x = document.getElementById("questionFive").getElementsByClassName("checked");
...
function checkToProceed() {
    if (document.getElementsByClassName("checked").length === 5) {
        document.getElementById("orangeNextButton").disabled = false;
        document.getElementById("orangeNextButton").style.opacity = 0.9;
    } else {
        document.getElementById("orangeNextButton").disabled = true;
        document.getElementById("orangeNextButton").style.opacity = 0.1;
    }
...
function nextToRecommendationPage() {
    ...
    $.ajax({
        type: "GET",
        url: "./orangePlanet/orangeAnswers?questionOne=" + questionOne + "&questionTwo=" + questionTwo + "&questionThree=" + questionThree + "&questionFour=" + questionFour + "&questionFive=" + questionFive + "&currentUserId=" + currentUserId + "&currentSurveyId=" + currentSurveyId,
        success: function (data, status) {
            location.replace("./studentRecommendation");
        }
    });
}
