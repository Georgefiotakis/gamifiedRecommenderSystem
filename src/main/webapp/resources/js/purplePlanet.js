...
$(document).ready(function () {
    ...
    // var currentUserId;
    // var currentSurveyId;
    document.getElementById("purpleNextButton").disabled = true;
    document.getElementById("purpleNextButton").style.opacity = 0.1;
...
function nextToOrangePlanet() {
    ...
    $.ajax({
        type: "GET",
        url: "./purplePlanet/purpleAnswers?questionOne=" + questionOne + "&questionTwo=" + questionTwo + "&questionThree=" + questionThree + "&questionFour=" + questionFour + "&questionFive=" + questionFive + "&currentUserId=" + currentUserId + "&currentSurveyId=" + currentSurveyId,
...
function checkToProceed() {
    if (document.getElementsByClassName("checked").length === 5) {
        document.getElementById("purpleNextButton").disabled = false;
        document.getElementById("purpleNextButton").style.opacity = 0.9;
    } else {
        document.getElementById("purpleNextButton").disabled = true;
        document.getElementById("purpleNextButton").style.opacity = 0.1;
    }
